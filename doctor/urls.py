...
urlpatterns = [
    ...
    path('create/patient_medicine/', create_patient_medicine, name='create_patient_medicine'),
    path('patient_medicine/<int:pk>/', get_patient_medicine, name='get_patient_medicine'),
]
